...
public class AllTuner extends LinearOpMode {
    ...
    public static double pT = 0.01;
    public static double pX = 0.02;
    public static double pY = 0.03;
    public static double iT = 0;
    public static double iX = 0.0015;
    public static double iY = 0;
    public static double dT = 0;
    public static double dX = 0.00065;
    public static double dY = 0;
    public static double KsT = 0.08;
    public static double KsX = 0.08;
    public static double KsY = 0.14;
    public TweakedPID headingControl= new TweakedPID(pT, iT, dT);
    public TweakedPID XControl= new TweakedPID(pX, iX, dX);
    public TweakedPID YControl= new TweakedPID(pY, iY, dY);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested()) {
            ...
            telemetry.addData("", XControl.getTelemetry());
            telemetry.update();
        }
